<%-- 
    Document   : menu
    Created on : Sep 1, 2018, 3:10:30 PM
    Author     : mateus
--%>
        ...
        <div class="main-container">
            <div class="sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul class="nav">                  
                        <li class="nav-item">
                            <a href="PaginaInicial" class="nav-link">
                                <i class="fa fa-home"></i> Home
                            </a>
                        </li>

                        <li class="nav-item">
                            <a href="GeneroCtr?metodo=listar" class="nav-link">
                                <i class="fa fa-cube"></i> Gêneros
                            </a>
                        </li>

                        <li class="nav-item">
                            <a href="EditoraCtr?metodo=listar" class="nav-link">
                                <i class="fa fa-book"></i> Editoras
                            </a>
                        </li>

                        <li class="nav-item">
                            <a href="CategoriaCtr?metodo=listar" class="nav-link">
                                <i class="fa fa-briefcase"></i> Categorias
                            </a>
                        </li>                        

                        <li class="nav-item">
                            <a href="AutorCtr?metodo=listar" class="nav-link">
                                <i class="fa fa-user"></i> Autor
                            </a>
                        </li>                        
                        
                        <li class="nav-item">
                            <a href="DocumentoCtr?metodo=listar&consultar=false" class="nav-link">
                                <i class="fa fa-archive"></i> Documento
                            </a>
                        </li>
                        <li class="nav-item">
